...
{
  const FULL_STACK_DEVELOPER_TITLE = 'Back-End Engineer';
  const FULL_STACK_DEVELOPER_PROFILE = 'Eight years of experience in the SaaS industry — as a full-stack web developer — primarily within a JavaScript environment. I specialize in leveraging cloud-based computing to deliver scalable solutions and collaborate closely with designers to develop high-performance web applications using TypeScript, React, and Node.js.';
  ...
  const SKILLS = [
    [
      'title' => 'TypeScript, MJS, and CJS',
      'prioritizedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SOFTWARE_DEVELOPER_TITLE],
      'keySkill' => true,
      'displayAsList' => true,
      'subSkills' => [
        [
        ...
        [
          ...
          'subSkills' => [
            [
              'title' => '<a href="https://hapi.dev/module/lab/" title="More About hapi Framework">hapi</a>',
              'keySkill' => true,
            ],
            [
            ...
            [
              'title' => '<a href="https://nightwatchjs.org" title="More About Nightwatch.js">Nightwatch.js</a>',
              'keySkill' => true,
            ],
          ],
        ],
    ...
    [
      ...
      'omittedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SUPPORT_ENGINEER_TITLE],
      'keySkill' => true,
      'displayAsList' => false,
      'subSkills' => [
        [
    ...
    [
      ...
      'omittedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SOFTWARE_DEVELOPER_TITLE],
      'keySkill' => true,
    ],
    [
    ...
    [
      'prioritizedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SOFTWARE_DEVELOPER_TITLE, self::SENIOR_SUPPORT_ENGINEER_TITLE],
      'keySkill' => true,
      'displayAsList' => false,
      'subSkills' => [
        [
    ...
    [
      'title' => '<a href="https://www.mysql.com/" title="More About MySQL">MySQL</a>',
      'prioritizedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SOFTWARE_DEVELOPER_TITLE, self::SENIOR_SUPPORT_ENGINEER_TITLE],
      'keySkill' => true,
    ],
    [
      'title' => '<a href="https://www.mongodb.com" title="More About MongoDB">MongoDB</a>',
      'prioritizedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SOFTWARE_DEVELOPER_TITLE, self::SENIOR_SUPPORT_ENGINEER_TITLE],
      'keySkill' => true,
    ],
    [
    ...
    [
      'title' => '<a href="https://www.java.com/en" title="More About Java">Java</a>',
      'prioritizedRoles' => [self::FULL_STACK_DEVELOPER_TITLE, self::SENIOR_SOFTWARE_DEVELOPER_TITLE],
      'keySkill' => false,
    ],
    [
  ...
  public final function getResumeTitle() {
    return $this->t->Helpers->getHttpGet('title', self::FULL_STACK_DEVELOPER_TITLE);
  }

  public final function getResumeProfile() {
    switch ($this->getResumeTitle()) {
      case self::FULL_STACK_DEVELOPER_TITLE:
        return self::FULL_STACK_DEVELOPER_PROFILE;
